...
class ServicesTerimaBarang {
  static Future<List<dynamic>?> listBox(String session) async {
    try {
      var response = await Dio()
          .post("https://indopaket.jtracker.id/api_mobile/api_mobile/list_box",
  ...
  static Future<DataListBox?> createBox(
    ...
    try {
      var response = await Dio()
          .post("https://indopaket.jtracker.id/api_mobile/api_mobile/add_box",
              data: jsonEncode({
